...
public abstract class AbstractMobDropsChallenge extends BaseChallenge {
  ...
  public void registerEventHandlers() {
    LivingEntityEvents.ON_LIVING_ENTITY_LOOT_DROP.register(
        (victim, damageSource, causedByPlayer) -> {
          try {
            ...
            // Even though causedByPlayer is true, it might not always be the case that the
            // damageSource is also a player...
            ...
            ItemEntity itemEntity =
                new ItemEntity(
                    victim.level(), victim.getX(), victim.getY(), victim.getZ(), itemStack);
            ...
            LOGGER.error(
                "Exception occured while trying to replace mob drop for {}: {}",
                victim.toString(),
                e);
